...
function parseRuleValidationErrors(message) {
  ...
  // Quoted display labels, e.g. ... field 'Produto da Análise' ...
  const labels = [];
...
function classifyFieldValue(value) {
  ...
  // Punctuation-only, or one of the conventional "nothing to say" tokens.
